...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p class="message">
                Your shipment <span class="shipment-id">#{{ $shipment->shipment_id }}</span> was not claimed by the receiver.
            </p>
            ...
            <p class="message">
                Please contact your receiver or check your shipment status in Navi Cargo to ensure timely delivery.
            </p>
        </div>
