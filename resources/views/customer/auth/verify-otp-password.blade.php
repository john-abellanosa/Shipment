                ...
                <form method="POST" action="{{ route('password.verify.submit') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="otp-container">
                            <input type="text" id="otp1" maxlength="1" pattern="\d" inputmode="numeric" required autofocus>
                            ...
                            <input type="text" id="otp5" maxlength="1" pattern="\d" inputmode="numeric" required>
                            <input type="text" id="otp6" maxlength="1" pattern="\d" inputmode="numeric" required>
                        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.addEventListener('paste', function(e) {
                ...
                if (pasteData.length === 6 && /^\d+$/.test(pasteData)) {
                    ...
                    hiddenOtpField.value = pasteData;
                    otpInputs[5].focus();
                }
            });
        });
