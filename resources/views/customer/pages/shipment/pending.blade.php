...
<script>
    ...
    function openCancelModal(shipmentId) {
        console.log("Opening cancel modal for shipment ID:", shipmentId);
        document.getElementById('hidden-cancel-shipment-id').value = JSON.stringify([shipmentId]);  
    ...
    <div id="cancel-modal" class="modal-new">
        <div class="modal-content-new">
            ...
            <form id="cancelForm" method="POST" action="{{ route('shipment_cancel') }}">
                @csrf
                <input type="hidden" name="user_ids" id="hidden-cancel-shipment-id">
                ...
                <div class="input-container"> 
                    <select name="cancel_reason" id="cancel_reason" required>
                        ...
                        <option value="Duplicate order">Duplicate</option>
...
<form method="POST" action="#">
    ...
    <div class="submit-container"> 
        <div class="submit-content">
            ...
            <span class="page-title">pending shipment</span> 
        </div>
                    ...
                    <table class="custom-table" id="table">
                        <thead>
                            <tr>
                                ...
                                <th><strong>Cancel Shipment</strong></th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($shipments as $shipment)
                                <tr>
                                    ...
                                    <td>
                                        <button class="view-btn" type="button" data-id='{{ $shipment->shipment_id }}'>
                                            <i class="fa fa-eye" aria-hidden="true"></i> View
                                        </button>
                                    </td>
                                    <td>
                                        <button class="cancel-btn" type="button" data-shipment-id="{{ $shipment->shipment_id }}">
...
<script>
    ...
    document.querySelectorAll('.view-btn').forEach(button => {
        button.addEventListener('click', function () {
            ...
            fetch(`/customer/pages/shipment/details/pending/${shipmentId}`)
