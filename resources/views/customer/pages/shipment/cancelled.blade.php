    ...
    <form method="POST" action="#">
        ...
        <div class="submit-container"> 
            <div class="submit-content">
                ...
                <span class="page-title">cancelled shipment</span> 
            </div>
                        ...
                        <table class="custom-table" id="table">
                            <thead>
                                <tr>
                                    ...
                                    <th><strong> Cancelled Date </strong></th>
                                    <th><strong> Reason of Cancellation </strong></th>
                            ...
                            <tbody>
                                @foreach($shipments as $shipment)
                                    <tr>
                                        ...
                                        <td>{{ \Carbon\Carbon::parse($shipment->cancelled_date)->format('F d, Y') }}</td>
...
<script>
    ...
    document.querySelectorAll('.view-btn').forEach(button => {
        button.addEventListener('click', function () {
            ...
            fetch(`/customer/pages/shipment/details/cancelled/${shipmentId}`)
