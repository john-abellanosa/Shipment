    ...
    <form method="POST" action="#">
        ...
        <div class="submit-container"> 
            <div class="submit-content">
                ...
                <span class="page-title">Claimed shipment</span> 
            </div>
                        ...
                        <table class="custom-table" id="table">
                            <thead>
                                <tr>
                                    ...
                                    <th><strong> Claimed Date </strong></th>
                            ...
                            <tbody>
                                @foreach($shipments as $shipment)
                                    <tr>
                                        ...
                                        <td>{{ \Carbon\Carbon::parse($shipment->claimed_date)->format('F d, Y') }}</td>
                                        <td>
...
<script>
    ...
    document.querySelectorAll('.view-btn').forEach(button => {
        button.addEventListener('click', function () {
            ...
            fetch(`/customer/pages/shipment/details/claimed/${shipmentId}`)
