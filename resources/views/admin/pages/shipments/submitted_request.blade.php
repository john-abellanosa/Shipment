...
<script>
    function openDeclineModal() {
        ...
        if (selectedUserIds.length === 0) {
            ...
            alertBox.innerHTML = `Please select at least one shipment before declining.`;
            ...
            document.getElementById('hidden-decline-user-ids').value = JSON.stringify(selectedUserIds);
...
<script>
    function openDispatchModal() {
        ...
        if (selectedUserIds.length === 0) {
            const alertBox = document.createElement('div');
            alertBox.className = 'error_alert';
            alertBox.innerHTML = `Please select at least one shipment before approving.`;
            document.body.appendChild(alertBox);
    ...
    <div id="dispatch-modal" class="modal-new">
        <div class="modal-content-new">
            <h3>Set a Dispatch Date</h3>
            <form method="POST" action="{{ route('approve.shipments') }}">
                @csrf
                <input 
                    type="hidden" 
                    name="user_ids" 
    ...
    <div id="decline-modal" class="modal-new">
        <div class="modal-content-new">
            <h3>Enter Reason for Declination </h3>
            <form method="POST" action="{{ route('decline.shipments') }}">
                @csrf
                <input 
                    type="hidden" 
                    name="user_ids" 
                    id="hidden-decline-user-ids"
                >
                <div class="input-container">
                    <textarea 
                        name="decline_reason"
                        placeholder="State the reason for declination..."
                ...
                <div class="modal-buttons-new">
                    <button type="submit" class="confirm-btn-new">Submit</button>
                    <button type="button" class="cancel-btn-new" onclick="closeDeclineModal()">Cancel</button>
                </div>
            </form>
        </div>
    </div>
...
@section('content')
    <form method="POST" action="#">
        ...
        <div class="submit-container">
            <button type="button" class="approve-btn" onclick="openDispatchModal()">
                <i class="fa fa-check"></i> Approve
            </button>
    
            <button type="button" class="decline-btn" onclick="openDeclineModal()">
...
<script>
    ...
    document.querySelectorAll('.view-btn').forEach(button => {
        button.addEventListener('click', function () {
            ...
            fetch(`/admin/pages/shipments/details/submitted_request/${shipmentId}`)
