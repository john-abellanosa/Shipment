...
<body>
        ...
        <div class="container">
            <div class="logo">
                <div>
                    ...
                    <strong onclick="window.location.href='{{ route('teller.login') }}'">Navi Cargo</strong>
                </div>
    ...
    <main>
        <div class="login-container">
            ...
            <h1>Login <span class="admin-text">Teller Panel</span></h1>
            
            <form method="POST" action="{{ route('teller_login') }}">
                @csrf
            ...
            <div class="register-section">
                ...
                <p>You are accessing the Navi Cargo Teller Portal. Please log in with your valid credentials to process transactions, handle shipment updates, and assist customers with their delivery requests.</p>
            </div>                             
        </div>
    </main>
