    ...
    <div class="dashboard">
        <div class="dashboard-header">
            <div>
                ...
                <p class="dashboard-subtitle">Track and manage all shipment statuses in real-time</p>
            </div>            
        ...
        <div class="section-container">
            <div class="section-header">
                ...
                <h2 class="section-title">Shipment Status</h2>
                <div class="section-line"></div>
            </div>

            <div class="card-grid">
                <!-- Shipment Requests -->
                <a href="{{ route('teller.pages.request') }}" class="stat-card-link">
                ...
                <!-- Approved Shipments -->
                <a href="{{ route('teller.pages.approved') }}" class="stat-card-link">
                    <div class="stat-card green">
                        <div class="stat-card-header">
                            <div class="stat-card-content">
                                <div class="stat-card-count">{{ $approved }}</div>
                                <div class="stat-card-title">Approved Shipments</div>
                            </div>
                            <div class="stat-card-icon-wrapper">
                                <div class="stat-card-icon-bg"></div>
                ...
                <!-- Queued Shipments -->
                <a href="{{ route('teller.pages.queued') }}" class="stat-card-link">
                    <div class="stat-card yellow">
                        <div class="stat-card-header">
                            <div class="stat-card-content">
                                <div class="stat-card-count">{{ $queued }}</div>
                                <div class="stat-card-title">Queued Shipments</div>
                            </div>
                            <div class="stat-card-icon-wrapper">
                                <div class="stat-card-icon-bg"></div>
                ...
                <a href="{{ route('teller.pages.in_transit') }}" class="stat-card-link">
                    <div class="stat-card purple">
                        <div class="stat-card-header">
                            <div class="stat-card-content">
                                <div class="stat-card-count">{{ $inTransitCount }}</div>
                                <div class="stat-card-title">In Transit Shipments</div>
                            </div>
                            <div class="stat-card-icon-wrapper">
                                <div class="stat-card-icon-bg"></div>
                ...
                <a href="{{ route('teller.pages.dispatched') }}" class="stat-card-link">
                    <div class="stat-card teal">
                        <div class="stat-card-header">
                            <div class="stat-card-content">
                                <div class="stat-card-count">{{ $dispatchedCount }}</div>
                                <div class="stat-card-title">Dispatched Shipments</div>
                            </div>
                            <div class="stat-card-icon-wrapper">
                                <div class="stat-card-icon-bg"></div>
                ...
                <a href="{{ route('teller.pages.claimed') }}" class="stat-card-link">
                    <div class="stat-card green">
                        <div class="stat-card-header">
                            <div class="stat-card-content">
                                <div class="stat-card-count">{{ $claimed }}</div>
                                <div class="stat-card-title">Claimed Shipments</div>
                            </div>
                            <div class="stat-card-icon-wrapper">
                                <div class="stat-card-icon-bg"></div>
                ...
                <a href="{{ route('teller.pages.unclaimed') }}" class="stat-card-link">
                    <div class="stat-card red">
                        <div class="stat-card-header">
                            <div class="stat-card-content">
                                <div class="stat-card-count">{{ $unclaim }}</div>
                                <div class="stat-card-title">Unclaim Shipments</div>
                            </div>
                            <div class="stat-card-icon-wrapper">
                                <div class="stat-card-icon-bg"></div>
                ...
                <a href="{{ route('teller.pages.declined') }}" class="stat-card-link">
                    <div class="stat-card red">
                        <div class="stat-card-header">
                            <div class="stat-card-content">
                                <div class="stat-card-count">{{ $declined }}</div>
                                <div class="stat-card-title">Declined Shipments</div>
                            </div>
                            <div class="stat-card-icon-wrapper">
                                <div class="stat-card-icon-bg"></div>
                        ...
                        <div class="stat-card-description">
                            Shipment requests that were declined due to various reasons.
                        </div>
                    </div>
                </a>
            </div>
